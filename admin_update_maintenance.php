                ...
                <div class="row">
                    ...
                    ?>
                            ...
                            <div class="card-header">
                                <h4 class="card-title text-center">ติดตามงานแจ้งซ่อม</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="myTable" class="display" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                INNER JOIN tbl_department ON department = department_id  Where sid > '1' && sid < '5' ");
                                                $select_stmt->execute();
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <h5 mt-4>รายละเอียดใบแจ้งซ่อม</h5>
                                                                        <hr>
                                                                        <div class="row">
                                                                            <div class="col-md-2">
                                                                                <label for="case_id"
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <textarea class="form-control"
                                                                                    ...
                                                                                    readonly><?php echo $row['problems_found'] ?></textarea>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <textarea class="form-control" id="note"
                                                                                    name="note"
                                                                                    rows="2"> <?php echo $row['note'] ?></textarea>
