                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input class="form-control"
                                                                                    ...
                                                                                    type="text" value="<?php echo $row['date_completion'] ?>">
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <textarea class="form-control"
                                                                                    id="problems_found"
                                                                                    name="problems_found"
                                                                                    rows="2" readonly><?php echo $row['problems_found'] ?></textarea>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <textarea class="form-control"
                                                                                    ...
                                                                                    rows="2"  readonly><?php echo $row['details'] ?></textarea>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <textarea class="form-control" id="note"
                                                                                    name="note" rows="2"> <?php echo $row['note'] ?></textarea>
